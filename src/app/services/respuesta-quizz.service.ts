...
export class RespuestaQuizzService {
  ...
  searchByCode(codigo: string): Observable<any>{
    return this._firestore.collection('cuestionarios', ref => ref.where('codigo', '==', codigo)).get()
  }
  ...
  deleteRespuesta(id: string): Promise<any>{
